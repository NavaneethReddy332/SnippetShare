          ...
          {loading ? (
            ...
            <div className="space-y-1">
              {snippets.map((snippet) => (
                <Link key={snippet.id} href={`/snippet/${snippet.id}`} className="group flex items-center gap-3 px-3 py-2 rounded border border-transparent hover:border-border transition-colors">
