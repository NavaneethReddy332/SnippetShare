                ...
                <a className="group block p-5 rounded-lg border border-border bg-card hover:border-primary/30 hover:bg-card/80 hover:shadow-[0_0_15px_-5px_hsl(var(--primary)/0.1)] transition-all">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className={`p-2 rounded ${snippet.language === 'javascript' ? 'bg-yellow-500/10 text-yellow-500' : 'bg-blue-500/10 text-blue-500'}`}>
                      ...
                      {snippet.isPrivate && (
                        <span className="px-2 py-0.5 rounded-full bg-red-500/10 text-red-500 text-xs border border-red-500/20 flex items-center gap-1">
